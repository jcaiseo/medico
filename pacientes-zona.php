...
include('controllers/connection.php');
	...
	$query = mysql_query("SELECT count(ag_medico_paciente.id) AS cantidad
						...
						WHERE ag_medico_paciente.estado = '0'
						AND ag_medico_paciente.zona = '".$_REQUEST['z']."'") or die(mysql_error());
	
	$row = mysql_fetch_array($query);	
?>

<div class="breadcrum">
    <a href="consult.php">Inicio</a> > Pacientes Zona <?php echo $_REQUEST['z']; ?>
</div>

<h3>Listado de Pacientes Zona <?php echo $_REQUEST['z']; ?> <span class="pull-right">Cantidad: <?php echo $row['cantidad']; ?></span></h3>
...
$(document).ready(function() { 
       ...
       $("#pacientes").load( "controllers/pacientes-zona.php?z=<?php echo $_REQUEST['z']; ?>" ); 
