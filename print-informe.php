...
<h3 style="text-align:center"> Informe Estadístico - MEDICO A DOMICILIO</h3>
<h4 style="text-align:center"> Desde:<?php echo fecha_rev($fecha_desde); ?> Hasta:<?php echo fecha_rev($fecha_desde); ?></h4>
