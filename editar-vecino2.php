...
<form action="<?php $_SERVER['PHP_SELF']?>" method="post" class="form-horizontal">
     ...
     <div class="form-group">
      ...
      <div class="col-sm-3">          
         <input class="input-text"  name="nombres" id="nombres" value="<?php echo @$nombre ?>"/> 
      </div>     
   </div>
     ...
     <div class="form-group">
      ...
      <div class="col-sm-3">
         <input class="input-text"  name="apellido_paterno" id="apellido_materno" value="<?php echo @$apellido_paterno ?>"/> 
      </div>
  ...
  <script>
  $(function() {
  $( "#fecha" ).datepicker({dateFormat: 'dd-mm-yy',changeMonth: true, changeYear: true,yearRange: '1930:'});
  });
  </script>       
   ...
   <!-- Inicio Dirección y Número -->
        ...
        <div class="form-group">      
            ...
            <div class="col-sm-3">
             <input class="input-text" name="direccion" id="direccion" value="<?php echo @$direccion ?>"/> 
            </div> 
        	 <label class="control-label col-sm-2">Número</label>
            <div class="col-sm-1">
	         <input class="input-text" name="numero" id="numero" value="<?php echo @$numero ?>"/> 
            </div>    
        </div>
		...
		<div class="form-group">
            ...
            <div class="col-sm-3">
	        <input class="input-text" name="telefono" id="telefono" value="<?php echo @$telefono ?>"/> 
            </div>
    ...
    <div class="form-group">
           <label class="control-label col-sm-2">Fecha Nacimiento</label>
            <div class="col-sm-3">
          <input class="input-text" name="fecha_nac" id="fecha" value="<?php echo @$fecha_nac ?>"/> 
            </div>
