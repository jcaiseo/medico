...
if(isset($_POST['guardar'])){
	...
	$uv = $_REQUEST['uv'];  
	$referencia_direc = $_REQUEST['referencia_direc'];
  ...
  $( "#fecha" ).datepicker({dateFormat: 'dd-mm-yy',changeMonth: true, changeYear: true,yearRange: '1930:'});
   ...
   <!-- Inicio Dirección y Número -->
		...
		<div class="form-group">
            ...
            <div class="col-sm-3">
	       <input class="input-text" name="email" type="email" id="email" value="<?php echo @$email ?>" disabled/> 
            </div>       
        </div>
    ...
    <div class="form-group">
           <label class="control-label col-sm-2">Fecha Nacimiento</label>
            <div class="col-sm-3">
          <input class="input-text" name="fecha_nac" id="fecha" value="<?php echo @$fecha_nac ?>" disabled/> 
            </div>
